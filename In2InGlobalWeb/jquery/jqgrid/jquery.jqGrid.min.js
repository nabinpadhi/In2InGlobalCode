                ...
                if (this.tagName.toUpperCase() != "TABLE") alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(a.jgrid.errors.model);
                        ...
                        var k = a("<div class='ui-jqgrid-view'></div>"),
                            ...
                            n = (a.browser.webkit || a.browser.safari) && parseFloat(a.browser.version)< 536.5 ? true : false;
                        d = this;
        ...
        setGridWidth: function (c, e) {
            return this.each(function () {
                if (this.grid) {
                    var b = this,
                        f, g = 0,
                        h = (a.browser.webkit || a.browser.safari) && parseFloat(a.browser.version)< 536.5 ? 0 : b.p.cellLayout,
                        i, d = 0,
                        k = false,
                        m = b.p.scrollOffset,
                        l, n = 0,
        ...
        if (typeof k !== "undefined" && a.isFunction(k)) g = k(a(c).text(), e, c);
            ...
            switch (h) {
                ...
                case "currency":
                    ...
                    break;
                case "checkbox":
                    i = e.colModel.editoptions ? e.colModel.editoptions.value.split(":") : ["True", "False"];
        ...
        checkValues: function (c, e, b, f, g) {
            ...
            if (h) {
                ...
                if (h.date === true) if (!(f === false && this.isEmpty(c))) {
                    ...
                    if (!this.checkDate(e, c)) return [false, i + ": " + a.jgrid.edit.msg.date + " - MM/DD/YYYY (e.g. 01/31/2014)", ""]
                }
                                ...
                                a(l, j).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        ...
                                        if (p) a.isFunction(b.delfunc) ? b.delfunc.call(m, p) : a(m).jqGrid("delGridRow", p, h);
                                                ...
                                                ShowTPMIntimation($('#alertcnt').find('div').first().text(),"Error");
//                                            a.jgrid.viewModal("#" + k.themodal, {
//                                                gbox: "#gbox_" + m.p.id,
//                                                jqm: true
//                                            });
//                                            a("#jqg_alrt").focus()
                            ...
                            if (b.search) {
                                l = a("<td class='ui-pg-button ui-corner-all'></td>");
                                i = i || {};
                                a(l).append("<div class='ui-pg-div'><span class='ui-icon " + b.searchicon + "'></span> Search</div>");
                                a("tr", j).append(l);
                                a("tr", j).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");
                            ...
                            if (b.refresh) {
                                l = a("<td class='ui-pg-button ui-corner-all'></td>");
                                a(l).append("<div class='ui-pg-div'><span class='ui-icon " + b.refreshicon + "'></span> Refresh</div>");
                                a("tr", j).append(l);
                                a("tr", j).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");
                                a(l, j).attr({
            ...
            if (d === "1") {
                ...
                if (p[0] === false) {
                    try {
                        ...
                        ShowValidationMessageWindow(p[1]);
                        //commented by Nabin 
                ...
                if (!(!f.grid || f.p.cellEdit !== true)) {
                    ...
                    if (!(g == "subgrid" || g == "cb" || g == "rn")) {
                        ...
                        if (d.editable === true && b === true && !i.hasClass("not-editable-cell")) {
                            ...
                            //commented by nabin : because of auto save
                        ...
                        if (i !== b.p.savedRow[f].v) {
                            ...
                            if (j[0] === true) {
                                ...
                                if (b.p.cellsubmit == "remote") if (b.p.cellurl) {
                                    ...
                                    ShowTPMIntimation(a.jgrid.errors.nourl,"Error");
                                    //commented by nabin
    ...
    if (ErrMsg != null) {
        if (ErrMsg == "No Session") {
            ...
            if (ErrMsg.indexOf('Success') > -1) {
                ShowTPMIntimation(ErrMsg.split('-')[1], 'Success');
                return;
            }
            else if (ErrMsg.indexOf('Failed') > -1) {
                ShowTPMIntimation(ErrMsg.split('-')[1], 'Failed');
                return;
            }
