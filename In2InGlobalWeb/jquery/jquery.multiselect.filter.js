	...
	$.widget("ech.multiselectfilter", {
		...
		_create: function(){
			var self = this,
				...
				// wrapper elem
				wrapper = (this.wrapper = $('<div class="ui-multiselect-filter">'+(opts.label.length ? opts.label : '')+'<div class="roundedCorners curvyIgnore" style="position:relative;float:left;height:20px;width:'+opts.width+'px"><input style="border-width:0px;border-style:none" placeholder="'+opts.placeholder+'" type="search" class="searcheaderText"' + (/\d/.test(opts.width) ? 'style="width:'+opts.width+'px"' : '') + ' /></div></div>').prependTo( this.header ));
