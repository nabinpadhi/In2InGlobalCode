...
resetMainTableHeight(opts.collapsed);
return false;
});
}
if(opts.minimizable){
...
win.window({title:opts.title,width:opts.width,height:opts.height,collapsible:false,minimizable:true,maximizable:false,shadow:false,draggable:false,resizable:false,closed:true,onBeforeOpen:function(){
...
win.window("window").css({left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop+20});
win.window("open");
...
//Added By Nabin for Action Management Screen.
ResizeGrid("o");
}
};
