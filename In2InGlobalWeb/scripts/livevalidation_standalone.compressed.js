...
var Validate = {
    ...
    PASSWORD: function (B, C) {
        var C = C || {};
        var A = C.failureMessage || "Please enter atleast one  lower case character[a-z], one upper case character[A-Z]";
        Validate.Format(B, {
            failureMessage: A,
            pattern: /^.*(?=.*[a-z])(?=.*[A-Z]).*$/
        });
    ...
    NumberInclusion: function (B, C) {
        var C = C || {};
        var A = C.failureMessage || "Please enter password containing atleast one numeric value";
        Validate.Format(B, {
            failureMessage: A,
            pattern: /^.*(?=.*\d).*$/i
        });
    ...
    SpecialCharacter: function (B, C) {
        var C = C || {};
        var A = C.failureMessage || "Please enter password containing atleast one special character.[!@#%^_*] ";
        Validate.Format(B, {
            failureMessage: A,
            pattern: /^.*(?=.*[!@#%^_*]).*$/i
        });
    ...
    Exclusion: function (A, B) {
        var B = B || {};
        B.failureMessage = B.failureMessage || " : ; $  < & > '  Must not be included";
        B.negate = true;
    ...
    Confirmation: function (C, D) {
        ...
        var D = D || {};
        var B = D.failureMessage || "Password does not match";
