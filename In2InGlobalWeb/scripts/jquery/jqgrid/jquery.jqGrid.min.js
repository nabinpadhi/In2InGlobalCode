                ...
                if (this.tagName.toUpperCase() != "TABLE") alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(a.jgrid.errors.model);
                        ...
                        var k = a("<div class='ui-jqgrid-view'></div>"),
                            ...
                            n = (a.browser.webkit || a.browser.safari) &&  (parseInt(a.browser.version.toString().split(".")[0]) <= 536 && parseInt(a.browser.version.toString().split(".")[1]) <= 5) ? true : false;
                        d = this;
                        ...
                        var j = function (s, t) {
                            ...
                            q = function (s, t, w, y, E) {
                                t = p(s, t, w, E, "add");
                                return '<td role="gridcell" class="WrapText" ' + v(w, y, t, E, s, true) + ">" + t + "</td>"
                            },
                            u = function (s, t, w) {
                                            ...
                                            case "script":
                                                a.ajax(a.extend({
                                                    ...
                                                    success: function (K, M, H) {   
                                                        if(H.getResponseHeader("ErrorMsg"))
                                                        {                                           
                        ...
                        if (this.p.multiselect) {
                            ...
                            a("#cb_" + a.jgrid.jqID(d.p.id), this).bind("click", function () {
                                ...
                                if (this.checked) {
                                 selectChildGridRows(d.p.id,true);
                                    a(d.rows).each(function (t) {
                                        if (t > 0) if (!a(this).hasClass("ui-subgrid") && !a(this).hasClass("jqgroup") && !a(this).hasClass("ui-state-disabled")) {
                                            //Addedd By Nabin to revert the row selection on certain criteria.
                                            if (PreCheckSelection(this.id)) {
                                                ...
                                                // Added below condition By AP to avoid selection of add new row
                                                if(this.id != 'new_row'){
                                 ...
                                 selectChildGridRows(d.p.id,false);
                                    a(d.rows).each(function (t) {
                        ...
                        a(d).before(g.hDiv).click(function (s) {
                            ...
                            if (d.p.datatype == "local") {
                                ...
                                //$("#" + d.p.id + "_iladd").removeClass("ui-state-disabled");
                ...
                if (e) try {
                    ...
                    a(this.p.colModel).each(function (v) {
                        ...
                        if (e[f] !== undefined) {
                            ...
                            //modified by AP for XSS attack
                            if(ValidateStrings(d)){                            
        ...
        addRowData: function (c, e, b, f) {
            ...
            if (e) {
                ...
                this.each(function () {
                    ...
                    g = true
                    //nabin after row update
                    //alert();
                    //a(this).jqGrid().trigger("reloadGrid");
                })
            }
            return g
        },
        ...
        showHideCol: function (c, e) {
            return this.each(function () {
                ...
                if (b.grid) {
                    ...
                    if (f === true) a(b).jqGrid("setGridWidth", b.p.shrinkToFit === true ? b.p.width : b.p.width);
        ...
        setGridWidth: function (c, e) {
            return this.each(function () {
                if (this.grid) {
                    ...
                    var b = this,
                        f, g = 0,
                        h = (a.browser.webkit || a.browser.safari) &&  (parseInt(a.browser.version.toString().split(".")[0]) <= 536 && parseInt(a.browser.version.toString().split(".")[1]) <= 5) ? 0 : b.p.cellLayout,                      
                        i, d = 0,
                        k = false,
                        m = b.p.scrollOffset,
                        l, n = 0,
...
(function (a) {
    ...
    a.unformat = function (c, e, b, f) {
        ...
        if (typeof k !== "undefined" && a.isFunction(k)) g = k(a(c).text(), e, c);
            ...
            switch (h) {
                ...
                case "currency":
                    ...
                    break;
                case "checkbox":
                    i = e.colModel.editoptions ? e.colModel.editoptions.value.split(":") : ["Yes", "No"]; //Nabin
        ...
        var alternateValue = null;
        if(a(c).text() == "")
        {
           if(a(c).find("input").first())                       
            alternateValue = $("#"+a(c).find("input").first().attr("id")).val();           
           else
            alternateValue = a(c).html();
        }
        else 
            alternateValue = a(c).html();        
        return g !== undefined ? g : f === true ? a(c).text() : a.jgrid.htmlDecode(alternateValue)
    };
        ...
        createEl: function (c, e, b, f, g) {
            ...
            switch (c) {
                case "textarea":
                    ...
                    d.value = b;
                    //added by nabin
                    if (!e.rows) e.rows = d.value.split("\n").length;
                    i(d, e);
                    e = h(d, e);                   
                    a(d).attr({
                        role: "textbox",
        ...
        checkValues: function (c, e, b, f, g) {
            ...
            if (h) {
                ...
                if (h.date === true) if (!(f === false && this.isEmpty(c))) {
                    e = b.p.colModel[e].formatoptions && b.p.colModel[e].formatoptions.newformat ? b.p.colModel[e].formatoptions.newformat : b.p.colModel[e].datefmt || "m/d/y";
                    if (!this.checkDate(e, c)) return [false, i + ": " + a.jgrid.edit.msg.date + " - MM/DD/YYYY", ""]
                }
                    ...
                    if (a("#" + r.themodal).html() !== null) {
                            ...
                            if (q[0] && !c[f.p.id].processing) {
                                ...
                                x = a.extend({
                                    ...
                                    complete: function (D, C) {
                                        //added by nabin
                                        a("#" + f.p.id + "_ilcancel").addClass("ui-state-disabled");
                                        a("#" + f.p.id + "_ilsave").addClass("ui-state-disabled");
                                        
                                        a('#' + f.p.id  + '_iladd').removeClass('ui-state-disabled');
                                        //a("#del_"+f.p.id).addClass("ui-state-disabled");
                                        if (C != "success") {
                                            q[0] = false;
                        ...
                        a("#eData", "#" + l + "_2").click(function () {
                           a.jgrid.hideModal("#" + r.themodal, {
                            ...
                            //Added By Nabin to avoid vertical scroll bar after delete dialog closed
                            $('.ui-jqgrid-bdiv').onfocus = new function(){
                    ...
                    if (!(!m.grid || typeof e != "string")) {
                        ...
                        for (var o = 0; o < n; o++) {
                            ...
                            if (b.add) {
                                ...
                                a(l).append("<div class='ui-pg-div'><span class='ui-icon addiconbutton " + b.addicon + "'></span>" + b.addtext + "</div>");
                                a("tr", j).append(l);
                                a(l, j).attr({
                                    title: b.addtitle || "",
                                    id: g.id || "add_" + r
                            ...
                            if (b.del) {
                                l = a("<td class='ui-pg-button ui-corner-all'></td>");
                                h = h || {};
                                a(l).append("<div class='ui-pg-div'><span class='ui-icon " + b.delicon + "'></span>" + "Delete" + "</div>");
                                a("tr", j).append(l);
                                a(l, j).attr({
                                    title: b.deltitle || "",
                                    id: h.id || "del_" + r
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        ...
                                        if (m.p.multiselect) {
                                            ...
                                            //Added by samar to exclude the new row while deleting
                                           if(p.indexOf('new_row')>0)
                                           {
                                        ...
                                        if (p) a.isFunction(b.delfunc) ? b.delfunc.call(m, p) : a(m).jqGrid("delGridRow", p, h);
                                                ...
                                                ShowAlertWindow($('#alertcnt').find('div').first().text(),"Error", "#E8473E");
//                                            a.jgrid.viewModal("#" + k.themodal, {
//                                                gbox: "#gbox_" + m.p.id,
//                                                jqm: true
//                                            });
                            ...
                            m.keys === true && a(q).bind("keydown", function (x) {
                                ...
                                if (x.keyCode === 13) {
                                    ...
                                    if (a(n).jqGrid("saveRow", c, m)) if (n.p._inlinenav) try {
                                        a(n).jqGrid("showAddEditButtons")
                                        //Modified By Nabin                                     
                                        a(n).jqGrid().trigger("reloadGrid");

                                        //a(n).jqGrid("setSelection", recentSavedRow)                                        
                                    } catch (C) { }
                                    return false
                                }
                            });
                ...
                a('td[role="gridcell"]', q).each(function (A) {
                    ...
                    if (n != "cb" && n != "subgrid" && u.editable === true && n != "rn" && !a(this).hasClass("not-editable-cell")) {
                        ...
                        if (p[0] === false) {
                            ...
                            //p[1] = o[n] + " " + p[1]; commneted by AP to avoid XSS attack
                             p[1] =   p[1];
                            return false
                        }
...
//                        })
                ...
                if (k.url == "clientArray") {
                    ...
                    updateExtraParams();
                    if (k.url.indexOf("?") == -1 && updateParams != "") {
                        updateParams = "?" + updateParams
                    }
                    if (k.url.indexOf("?") > 0 && updateParams != "") {
                        updateParams = "&" + updateParams
                    }
                    k.url = k.url.replace(updateParams, "");
                    a.ajax(a.extend({
                        url: k.url + updateParams,
                            ...
                            if (B === "success") {
                                ...
                                if (J === true) {
                                    ...
                                    for (J = 0; J < l.p.savedRow.length; J++) if (l.p.savedRow[J].id == c) {
                                        r = J;
                                        //recentSavedRow = l.p.savedRow[J].id;
                                        break
                                    }
                                    r >= 0 && l.p.savedRow.splice(r, 1);
                                ...
                                //Added by samar-- to show the success message after row saved
//                                 var ErrMsg = A.getResponseHeader("ErrorMsg");
//                                if (ErrMsg == null) {
                                a(l).jqGrid().trigger("reloadGrid");
                                //}
                                 showSuccessMessage(l,A); 
                            }
                        },
                        error: function (A, B) {
                            a("#lui_" + l.p.id).hide();
                            if (a.isFunction(k.errorfunc)) k.errorfunc.call(l, c, A, B);
                                    ...
                                    ShowMessageWindow(A.responseText,"Error","#E8473E");
                                //commented  by nabin
...
//                                })
                            ...
                            k.restoreAfterError === true && a(l).jqGrid("restoreRow", c, k.afterrestorefunc)
                            //added by samar to show the error message after row save
                             showErrorMessage();
                        }
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    if (c.useFormatter) a("#" + a.jgrid.jqID(c.rowID) + " .ui-inline-edit", "#" + a.jgrid.jqID(e.p.id)).click();
                        ...
                        a("#" + e.p.id + "_ilsave").attr("title","Save Row");
                ...
                if (this.grid) {
                    ...
                    e.add && a(b).jqGrid("navButtonAdd", c, {
                        ...
                        onClickButton: function () {
                            ...
                            if (!e.addParams.useFormatter) {
                                ...
                                //Modified by samar : Called after inline ADD row click and cells of add row are in editmode
                                BeforeAddRow();
                            }
                            //Modified by samar :Called after inline ADD row click and cells of add row are in editmode
                            AfterAddrow(); 
                    ...
                    if (e.save) {
                        a(b).jqGrid("navButtonAdd", c, {
                            caption: e.savetext || "Save",
                            title: e.savetitle || "Save row",
                            buttonicon: e.saveicon,
                            id: b.p.id + "_ilsave",
                            onClickButton: function () {                                
                                if(b.p.savedRow.length >0)
                                {
                                    var i = b.p.savedRow[0].id;                                    
                                    if($("#" + b.p.id + "_ilsave").attr("title") == "Save Row")
                                    {
                                        if (i) {
                                        ...
                                        a(b).jqGrid("saveCell", b.p.savedRow[0].id, b.p.savedRow[0].ic) && a(b).jqGrid("showAddEditButtons")
                                }                               
                            }
                        });
                    ...
                    if (e.cancel) {
                        a(b).jqGrid("navButtonAdd", c, {
                            ...
                            onClickButton: function () {
                                ...
                                {
                                    var i = b.p.savedRow[0].id;
                                    var ic = b.p.savedRow[0].ic;
                                    //f.p.iCol
                                    if (i) {
                                        a(b).jqGrid("restoreRow", i, e.editParams);
                                        if (ic) {
                                            a(b).jqGrid("restoreCell", i, ic);
                                        }
                ...
                if (!(!f.grid || f.p.cellEdit !== true)) {
                    ...
                    if (!(g == "subgrid" || g == "cb" || g == "rn")) {
                        ...
                        if (d.editable === true && b === true && !i.hasClass("not-editable-cell")) {
                            ...
                            a("#" + f.p.id + "_ilsave").removeClass("ui-state-disabled"); 
                            a("#" + f.p.id + "_ilsave").attr("title","Save Cell")                         
                            a.isFunction(f.p.beforeEditCell) && f.p.beforeEditCell.call(f, f.rows[c].id, g, h, c, e);
                            if(a(l).is("textarea"))
                            {
                            a(l).height(a(i).height());
                            }
                            a(i).html("").append(l).attr("tabindex", "0");


                            window.setTimeout(function () {
                                //Added By Nabin to Show the date picker on focus   
                                
                                if(a(l).attr("id"))
                                {  
                                    if(a(l).attr("id").indexOf("Date") > 0)
                                    a(l).datepicker();
                               }                               
                            ...
                            a("input, select, textarea", i).bind("keydown", function (n) {
                                if (n.keyCode === 27) 
                                {
                                    if (a("input.hasDatepicker", i).length > 0) a(".ui-datepicker").is(":hidden") ? a(f).jqGrid("restoreCell", c, e) : a("input.hasDatepicker", i).datepicker("hide");                                      
                                else a(f).jqGrid("restoreCell", c, e);
                                    a("#" + f.p.id + "_ilsave").addClass("ui-state-disabled"); 
                                    a("#" + f.p.id + "_ilsave").attr("title","Save Row");
                                }
                                //Commented by Nabin
                                ...
                                if (!a(this).is("textarea")) {
                                    ...
                                    if (n.keyCode === 13) {
                                        var increment = n.shiftKey ? -1 : 1;
                                        // Do not go out of bounds
                                        var lastRowInd = a(f).jqGrid("getGridParam", "reccount")
                                        if (f.p.iRow + increment == 0 || f.p.iRow + increment == lastRowInd + 1)
                                            return;   // we could re-edit current cell or wrap
                                        else
                                            a(f).jqGrid("editCell", f.p.iRow + increment, f.p.iCol, true);
                                    }
                                }
                                else {
                        ...
                        if (i !== b.p.savedRow[f].v) {
                            ...
                            if (j[0] === true) {
                                ...
                                if (b.p.cellsubmit == "remote") if (b.p.cellurl) {
                                    ...
                                    v[m] = n.editoper;
                                    v = a.extend(f, v);
                                    //Commented By Nabin : to avoid blue screen on postback loading.
                                    //a("#lui_" + b.p.id).show();
                                    b.grid.hDiv.loading = true;
                                    
                                    updateExtraParams();
                                    if (b.p.cellurl.indexOf("?") == -1 && updateParams != "") {
                                        updateParams = "?" + updateParams
                                    }
                                    if (b.p.cellurl.indexOf("?") > 0 && updateParams != "") {
                                        updateParams = "&" + updateParams
                                    }
                                    b.p.cellurl = b.p.cellurl.replace(updateParams, "");
                                    a.ajax(a.extend({
                                        url: b.p.cellurl + updateParams,
                                        ...
                                        complete: function (q, u) {
                                            ...
                                            if (u == "success") if (a.isFunction(b.p.afterSubmitCell)) {
                                                ...
                                                if (x[0] === true) {
                                                    ...
                                                    //Added and commented By Nabin
                                                    //a(b).jqGrid().trigger("reloadGrid");
                                                } else {
                                                    if(x[1] != "")
                                                    ShowMessageWindow(x[1],"Error","#E8473E");
                                                    //commented by  nabin
                                        ...
                                        error: function (q, u) {
                                            ...
                                            a("#lui_" + b.p.id).hide();
                                            b.grid.hDiv.loading = false;                                            
                                            a.isFunction(b.p.errorCell) ? b.p.errorCell.call(b, q, u) : ShowMessageWindow(q.status + " : " + q.statusText + "<br/>" + u,"Error","#E8473E");//a.jgrid.info_dialog(a.jgrid.errors.errcap, q.status + " : " + q.statusText + "<br/>" + u, a.jgrid.edit.bClose);
                                            a(b).jqGrid("restoreCell", c, e)
                                        }
                                        
                                    }, a.jgrid.ajaxOptions, b.p.ajaxCellOptions || {}))
                                } else try {
                                    ShowMessageWindow(a.jgrid.errors.nourl,"Error","#E8473E");
                                    //commented by nabin
                                ...
                                window.setTimeout(function () {
                                    ShowMessageWindow( h + " " + j[1],"Error","#E8473E");
                        ...
                        a(b.rows[v]).hasClass("jqgrow") && a(b.rows[v].cells[c]).bind("click", function () {
                            ...
                            if (a(this).hasClass("sgcollapsed")) {
                                ...
                                if (b.p.subGridOptions.reloadOnExpand === true || b.p.subGridOptions.reloadOnExpand === false && !a(o).hasClass("ui-subgrid")) {
                                    ...
                                    a(o).show();
                                    //included by nabin to avoid inner page scrollbar.
                                    if(a.isFunction(window.parent.SetFrameHeight))
                                    {
...
function PreCheckSelection(rowid) {
    return true;
}
function selectChildGridRows(id,isSelected)
{
}
function showSuccessMessage(l, A) {
    var ErrMsg = A.getResponseHeader("ErrorMsg");
    if (ErrMsg != null) {
        if (ErrMsg == "No Session") {
            window.parent.DoNoSession();
        }
        else if (ErrMsg.indexOf("PageException.aspx") > 0) {
            window.parent.ShowExceptionWindow(ErrMsg);
             return;
        }
        else {
            ShowMessageWindow(serverMessages[ErrMsg], "Error", '#E8473E');
             return
        }
    }
    ShowMessageWindow("Data saved successfully", "Risk Assessment", '#000');
}
...
function ValidateStrings(rs_ValueToValidate)
{
