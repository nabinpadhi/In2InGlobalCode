...
;(function($) {
  ...
  function setup(n, o) {
    ...
    var b = $("<div id='"+mId+"' class='simplePassMeter' aria-controlled>")
      .append("<table cellpadding='0' cellspacing='0'><tr><td valign='top'><span class='simplePassMeterIcon'></td><td valign='top'></span><span class='simplePassMeterText'></span></td></tr>"+
  ...
  $.fn.simplePassMeter.defaults = {
    ...
    'defaultText': 'Enter password', // STRING  Text to show in password strength meter when no password is typed (i.e. user hasn't started typing yet)
    ...
    'requirements': {                   // OBJECT  All requirements that the password must fulfill.
      ...
      'minLength': {
        ...
        'message': '&nbsp;&nbsp; * Be atleast %V characters in length' // STRING  The message to display to the user if they do not meet the requirement. It can contain the special sequence %V which will be replaced by the value parameter for this requirement.
      },
      'noMatchField': {
      ...
      'numbers': {'value': true, 'regex': '[0-9]+', 'message': '&nbsp;&nbsp; * Have one digit'},
      
      // These requirements are turned off by default
      'lower': {'value': false, 'regex': '[a-z]+', 'message': '&nbsp;&nbsp; * Have one lower case'},
      'upper': {'value': false, 'regex': '[A-Z]+', 'message': '&nbsp;&nbsp; * Have one upper case'},
      'special': {'value': false, 'regex': '[^a-zA-Z0-9]+', 'message': '&nbsp;&nbsp; * Have one special character'}
    },
