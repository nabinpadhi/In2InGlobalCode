...
$(function () {
    ...
    $.speedoPopup.registerSmartSkin = function (b, j) {
        $.speedoPopup.smartSkins[b] = j
    };
...
(function (b, j, e, c) {
    j.fn.modules.register_module("smartskin", function (a) {
        function e() {
            j.SmartSkin.run_skin(a.theme, l);
            if (void 0 != b.speedoPopup.smartSkins[a.theme]) b.speedoPopup.smartSkins[a.theme](d, g)
        }
        b(c);
